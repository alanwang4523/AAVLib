...
import com.alanwang.aavlib.media.clipper.AWAVClipper;
import com.alanwang.aavlib.media.clipper.AWAudioClipper;
import com.alanwang.aavlib.media.clipper.AWVideoClipper;
import com.alanwang.aavlib.media.decoder.AWAudioHWDecoderToPCM;
import com.alanwang.aavlib.media.decoder.AWAudioHWDecoderToWav;
import com.alanwang.aavlib.media.encoder.AWAudioWavFileEncoder;
...
import com.alanwang.aavlib.media.muxer.AWAVAndroidMuxer;
...
public class TestLibMediaCoreActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class CommonProgressListener implements AWVoidResultListener {
        private String Tag;
