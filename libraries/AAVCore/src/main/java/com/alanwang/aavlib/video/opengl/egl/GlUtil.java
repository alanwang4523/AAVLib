package com.alanwang.aavlib.video.opengl.egl;
/*
...
public class GlUtil {
    ...
    public static int createTextureWithTextContent(String text) {
        ...
        //Create Nearest Filtered STTexture
    ...
    public static int create2DTexture(int width, int height) {
        ...
        setDefaultTexParameter(GLES20.GL_TEXTURE_2D);
    ...
    public static int createOESTexture() {
        ...
        setDefaultTexParameter(GLES11Ext.GL_TEXTURE_EXTERNAL_OES);
    ...
    public static void setDefaultTexParameter(int textureType) {
        ...
        GLES20.glTexParameterf(textureType, GLES20.GL_TEXTURE_MAG_FILTER,
                GLES20.GL_LINEAR);
        GLES20.glTexParameteri(textureType, GLES20.GL_TEXTURE_WRAP_S,
                GLES20.GL_CLAMP_TO_EDGE);
        GLES20.glTexParameteri(textureType, GLES20.GL_TEXTURE_WRAP_T,
                GLES20.GL_CLAMP_TO_EDGE);
